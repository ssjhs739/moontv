        ...
        <div className='space-y-2'>
          ...
          >
            ...
            >
              ...
              {/* 全屏状态下悬浮的退出全屏按钮（肉眼清晰可见，读屏完全可达） */}
              {isFullscreen && (
                <button
                  type='button'
                  aria-label='退出全屏'
                  onClick={handleToggleFullscreen}
                  className='fixed top-4 left-4 z-[999999] px-4 py-2 bg-black/75 hover:bg-black/90 active:bg-black text-white text-sm font-medium rounded-full backdrop-blur-md border border-white/20 shadow-2xl flex items-center gap-2 transition-all duration-200 cursor-pointer'
                >
                  <span aria-hidden='true'>✕</span>
                  <span>退出全屏</span>
                </button>
